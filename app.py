        ...
        try:
            ...
            for table in doc.tables:
                ...
                for row in table.rows[1:]:  # Skip header row
                    ...
                    patient_name_parts = patient_full_name.split()
                    doctor_name_parts = doctor_full_name.split()

                    # Extract the patient name parts
                    patient_surname = patient_name_parts[0]
                    patient_name = patient_name_parts[1]
                    patient_patronymic = patient_name_parts[2] if len(patient_name_parts) > 2 else None

                    # Extract the doctor name parts
                    doctor_surname = doctor_name_parts[0]
                    doctor_name = doctor_name_parts[1]
                    doctor_patronymic = doctor_name_parts[2] if len(doctor_name_parts) > 2 else None
                    ...
                    # print ecg_record columns names
